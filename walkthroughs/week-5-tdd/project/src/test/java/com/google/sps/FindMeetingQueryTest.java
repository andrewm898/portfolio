...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredWithAllDayOptional() {
    // Have each person have different events. We should just see the mandatory event options
    // since there are no times that work for the optional person.
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
    ...
    @Test
  public void everyAttendeeIsConsideredWithAvailableOptional() {
    // Have each person have different events. We should just see the first and last
    // chunks of the day, since they work with the optional person
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  public void noMandatoryAttendees() {
    // There are no mandatory attendees, just two optionals with several gaps in their schedules
    ...
    @Test
  public void noTimeForOptionals() {
    // There are no mandatory attendees, just two optionals with several gaps in their schedules
    // Query should return that there are no available times
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0930AM, DURATION_30_MINUTES),
